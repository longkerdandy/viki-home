 ...
 *
 * Inspired by Google Tink Project: https://github.com/google/tink https://github.com/google/tink/blob/master/java/src/main/java/com/google/crypto/tink/subtle/Bytes.java
 */
public final class Bytes {
   ...
   * {@code output}.
   */
  public static void xor(ByteBuffer output, ByteBuffer x, ByteBuffer y, int len) {
   ...
   * @return a new byte[] of length x.length.
   */
  public static byte[] xorEnd(final byte[] a, final byte[] b) {
